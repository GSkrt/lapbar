...
pixels in popup.png (1002 x 716); when the popup layout changes, retake popup.png and adjust MARKS.
...
MARKS = [  # number, x, y
    (1, 5, 92), (2, 272, 100), (3, 330, 100), (4, 5, 156), (5, 100, 300), (6, 44, 387), (7, 168, 387),
    (8, 5, 418), (9, 5, 618), (10, 5, 689),                                          # left column
    (11, 334, 72), (12, 544, 26), (13, 334, 457), (14, 334, 563), (15, 334, 647),   # middle column
    (16, 664, 26), (17, 664, 299), (18, 812, 692),                                  # right column
]
