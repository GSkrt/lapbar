...
def test_the_real_help_text_splits_into_text_and_its_four_pictures():
    ...
    assert images == ["screenshots/popup-guide.png", "screenshots/fitness.png", "screenshots/chart.png", "screenshots/data-window.png"]
